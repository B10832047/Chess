	...
	void move(char oper, string ter)
	{
		...
		else if (oper == '*')  //killing
		{
			if (board[ter[1] - '0'][ter[0] - 'a' + 1] != NULL) //judgment whether terminate is NULL before we move
			{
				...
				{
					if (ter[0] - posX == -1 && ter[1] - posY == 1 && posX - 'a' > 0 && posY - '0' + 1 < 9 && board[posY - '0' + 1][posX - 'a'] != NULL) //左下
					{
					...
					if (ter[0] - posX == 1 && ter[1] - posY == 1 && posX - 'a' + 2 < 9 && posY - '0' + 1 < 9 && board[posY - '0' + 1][posX - 'a' + 2] != NULL) //右下
					{
				...
				{
					if (ter[0] - posX == -1 && ter[1] - posY == -1 && posX - 'a' > 0 && posY - '0' - 1 > 0 && board[posY - '0' - 1][posX - 'a'] != NULL) //左上
					{
						board[posY - '0' - 1][posX - 'a'] = NULL;
						board[posY - '0' - 1][posX - 'a'] = this;
						board[posY - '0'][posX - 'a' + 1] = NULL;
					...
					if (ter[0] - posX == 1 && ter[1] - posY == -1 && posX - 'a' + 2 < 9 && posY - '0' - 1 > 0 && board[posY - '0' - 1][posX - 'a' + 2] != NULL) //右上
					{
						board[posY - '0' - 1][posX - 'a' + 2] = NULL;
						board[posY - '0' - 1][posX - 'a' + 2] = this;
						board[posY - '0'][posX - 'a' + 1] = NULL;
